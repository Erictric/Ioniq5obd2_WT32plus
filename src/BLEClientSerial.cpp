...
std::string targetDeviceName = "IOS-Vlink"; // Target BLE device
BLEUUID serviceUUID_FFF0("18F0"); 
BLEUUID rxUUID("2AF0");
BLEUUID txUUID("2AF1");
...
// const-safe overload forwards to mutable version
bool BLEClientSerial::begin(const char* localName)
{
